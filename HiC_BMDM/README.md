...
Workflow:
1. [bwa.sbatch]()
2. [pairtools_parse.sbatch]()
3. [pairtools_sort.sbatch]()
4. [pairtools_merge.sbatch]()
5. [pairtools_dedup.sbatch]()
6. [pairtools_filter.sbatch]()
7. [run_generate_site_positions.sbatch]()
8. [run_addfrag2pairs.sbatch]()
9. [juicer_pre.sbatch]()
10. [juicebox_dump.sbatch]()
