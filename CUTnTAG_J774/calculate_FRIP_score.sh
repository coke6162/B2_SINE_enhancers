...
## Example usage:
## bamDir=path peakDir=path outDir=path sbatch --array=0-7 calculate_frip_score.q
...
peakReads=`bedtools sort -i ${peakDir}/${queries[$SLURM_ARRAY_TASK_ID]}.bam_peaks.narrowPeak \
| bedtools merge -i - \
