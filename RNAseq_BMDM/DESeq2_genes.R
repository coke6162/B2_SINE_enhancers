...
write.table(resdata_nonresponsive_picc_2h, file.path(workingDir, "picc_BMDM_IFNG_2h_nonresponsive_padj0.90_baseMean100_log2FC0.10.txt"),  quote = FALSE, row.names = FALSE, sep = "\t")
write.table(resdata_nonresponsive_picc_4h, file.path(workingDir, "picc_BMDM_IFNG_4h_nonresponsive_padj0.90_baseMean100_log2FC0.10.txt"),  quote = FALSE, row.names = FALSE, sep = "\t")
write.table(resdata_nonresponsive_plat_2h, file.path(workingDir, "plat_BMDM_IFNG_2h_nonresponsive_padj0.90_baseMean100_log2FC0.10.txt"),  quote = FALSE, row.names = FALSE, sep = "\t")

# Write bed output files
write.table(bed_picc_2h, file.path(workingDir, "picc_BMDM_IFNG_2h.bed"), quote = FALSE, row.names = FALSE, sep = "\t")
write.table(bed_picc_4h, file.path(workingDir, "picc_BMDM_IFNG_4h.bed"), quote = FALSE, row.names = FALSE, sep = "\t")
write.table(bed_plat_2h, file.path(workingDir, "plat_BMDM_IFNG_2h.bed"), quote = FALSE, row.names = FALSE, sep = "\t")
write.table(bed_nonresponsive_picc_2h, file.path(workingDir, "picc_BMDM_IFNG_2h_nonresponsive_padj0.90_baseMean100_log2FC0.10.bed"),  quote = FALSE, row.names = FALSE, sep = "\t")
write.table(bed_nonresponsive_picc_4h, file.path(workingDir, "picc_BMDM_IFNG_4h_nonresponsive_padj0.90_baseMean100_log2FC0.10.bed"),  quote = FALSE, row.names = FALSE, sep = "\t")
write.table(bed_nonresponsive_plat_2h, file.path(workingDir, "plat_BMDM_IFNG_2h_nonresponsive_padj0.90_baseMean100_log2FC0.10.bed"),  quote = FALSE, row.names = FALSE, sep = "\t")