...
| bedtools sort -i - \
> picc_BMDM_IFNG_4h_vs_UT_IRGs_top750.bed
...
| sort -k3,3n \
| awk '(NR<=750){print $1}' \
> picc_BMDM_IFNG_2h_vs_UT_IRGs_top750_names.txt

# Get coordindates for top 750 IRGs
awk 'FNR==NR {a[$5] = $0; next} $1 in a {print a[$1]}' picc_BMDM_IFNG_2h_vs_UT.bed picc_BMDM_IFNG_2h_vs_UT_IRGs_top750_names.txt \
| bedtools sort -i - \
> picc_BMDM_IFNG_2h_vs_UT_IRGs_top750.bed
...
| sort -k3,3n \
| awk '(NR<=750){print $1}' \
> plat_BMDM_IFNG_2h_vs_UT_IRGs_top750_names.txt

# Get coordindates for top 750 IRGs
awk 'FNR==NR {a[$5] = $0; next} $1 in a {print a[$1]}' plat_BMDM_IFNG_2h_vs_UT.bed plat_BMDM_IFNG_2h_vs_UT_IRGs_top750_names.txt \
| bedtools sort -i - \
> plat_BMDM_IFNG_2h_vs_UT_IRGs_top750.bed