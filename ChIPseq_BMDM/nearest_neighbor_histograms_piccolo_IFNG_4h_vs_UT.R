...
# Read in tables
bound_Mm2_ISG <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm2_picc_BMDM_WT_IFNG_2h_STAT1_intersected_nearest_4h_vs_UT_ISG_top750", header = FALSE, sep = "\t")
bound_Mm2_ISG <- bound_Mm2_ISG[,c(1:3, 13)]
colnames(bound_Mm2_ISG) <- c("chr", "start", "end", "distance")
head(bound_Mm2_ISG)

shuffle_Mm2_ISG <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm2_picc_BMDM_WT_IFNG_2h_STAT1_intersected_shuffled_nearest_4h_vs_UT_ISG_top750", header = FALSE, sep = "\t")
shuffle_Mm2_ISG <- shuffle_Mm2_ISG[,c(1:3, 13)]
colnames(shuffle_Mm2_ISG) <- c("chr", "start", "end", "distance")
head(shuffle_Mm2_ISG)

unbound_Mm2_ISG <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm2_null_picc_BMDM_WT_IFNG_2h_STAT1_intersected_random2122_nearest_4h_vs_UT_ISG_top750", header = FALSE, sep = "\t")
unbound_Mm2_ISG <- unbound_Mm2_ISG[,c(1:3, 13)]
colnames(unbound_Mm2_ISG) <- c("chr", "start", "end", "distance")
head(unbound_Mm2_ISG)

unbound_Mm1a_ISG <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm1a_null_picc_BMDM_WT_IFNG_2h_STAT1_intersected_random2122_nearest_4h_vs_UT_ISG_top750", header = FALSE, sep = "\t")
unbound_Mm1a_ISG <- unbound_Mm1a_ISG[,c(1:3, 13)]
colnames(unbound_Mm1a_ISG) <- c("chr", "start", "end", "distance")
head(unbound_Mm1a_ISG)

unbound_Mm1t_ISG <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm1t_null_picc_BMDM_WT_IFNG_2h_STAT1_intersected_random2122_nearest_4h_vs_UT_ISG_top750", header = FALSE, sep = "\t")
...
pdf(file = "nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_STAT1_nearest_4h_vs_UT_ISG_top750_freqHist.pdf", width = 7, height = 7)
...
ggplot(data = combined_IRG) +
  geom_freqpoly(binwidth = 20, 
                ...
                aes(x = distance,
                    ...
                    y = ..count..),
                na.rm = TRUE) +
  labs(x = "Distance (kb) from nearest mouse piccolo BMDM ISG", y = "Number of B2-derived STAT1 piccolo BMDM peaks") +
...
# Read in tables
bound_Mm2_IRG <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm2_picc_BMDM_WT_IFNG_2h_STAT1_intersected_nearest_4h_vs_UT_IRG_top750", header = FALSE, sep = "\t")
bound_Mm2_IRG <- bound_Mm2_IRG[,c(1:3, 13)]
colnames(bound_Mm2_IRG) <- c("chr", "start", "end", "distance")
head(bound_Mm2_IRG)

shuffle_Mm2_IRG <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm2_picc_BMDM_WT_IFNG_2h_STAT1_intersected_shuffled_nearest_4h_vs_UT_IRG_top750", header = FALSE, sep = "\t")
shuffle_Mm2_IRG <- shuffle_Mm2_IRG[,c(1:3, 13)]
colnames(shuffle_Mm2_IRG) <- c("chr", "start", "end", "distance")
head(shuffle_Mm2_IRG)

unbound_Mm2_IRG <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm2_null_picc_BMDM_WT_IFNG_2h_STAT1_intersected_random2122_nearest_4h_vs_UT_IRG_top750", header = FALSE, sep = "\t")
unbound_Mm2_IRG <- unbound_Mm2_IRG[,c(1:3, 13)]
colnames(unbound_Mm2_IRG) <- c("chr", "start", "end", "distance")
head(unbound_Mm2_IRG)

unbound_Mm1a_IRG <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm1a_null_picc_BMDM_WT_IFNG_2h_STAT1_intersected_random2122_nearest_4h_vs_UT_IRG_top750", header = FALSE, sep = "\t")
unbound_Mm1a_IRG <- unbound_Mm1a_IRG[,c(1:3, 13)]
colnames(unbound_Mm1a_IRG) <- c("chr", "start", "end", "distance")
head(unbound_Mm1a_IRG)

unbound_Mm1t_IRG <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm1t_null_picc_BMDM_WT_IFNG_2h_STAT1_intersected_random2122_nearest_4h_vs_UT_IRG_top750", header = FALSE, sep = "\t")
...
# Plot number of peaks (y) vs. distance from nearest TSS (x) (legend)
pdf(file = "nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_STAT1_nearest_4h_vs_UT_IRG_top750_freqHist.pdf", width = 7, height = 7)
...
ggplot(data = combined_IRG) +
  geom_freqpoly(binwidth = 20, 
                ...
                aes(x = distance,
                    ...
                    y = ..count..),
                na.rm = TRUE) +
  labs(x = "Distance (kb) from nearest mouse piccolo BMDM IRG", y = "Number of B2-derived STAT1 piccolo BMDM peaks") +
  scale_color_manual(values = c("royalblue3", "black", "#A9A9A9", "#E5E4E2","#7393B3")) +
  theme_bw() +
  xlim(0, 500) +
  ylim(0, 100) +
...
# Read in tables
bound_Mm2_nonresponsive <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm2_picc_BMDM_WT_IFNG_2h_STAT1_intersected_nearest_4h_vs_UT_nonresponsive_random750", header = FALSE, sep = "\t")
...
shuffle_Mm2_nonresponsive <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm2_picc_BMDM_WT_IFNG_2h_STAT1_intersected_shuffled_nearest_4h_vs_UT_nonresponsive_random750", header = FALSE, sep = "\t")
...
unbound_Mm2_nonresponsive <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm2_null_picc_BMDM_WT_IFNG_2h_STAT1_intersected_random2122_nearest_4h_vs_UT_nonresponsive_random750", header = FALSE, sep = "\t")
...
unbound_Mm1a_nonresponsive <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm1a_null_picc_BMDM_WT_IFNG_2h_STAT1_intersected_random2122_nearest_4h_vs_UT_nonresponsive_random750", header = FALSE, sep = "\t")
...
unbound_Mm1t_nonresponsive <- read.table("nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_Mm1t_null_picc_BMDM_WT_IFNG_2h_STAT1_intersected_random2122_nearest_4h_vs_UT_nonresponsive_random750", header = FALSE, sep = "\t")
...
# Plot number of peaks (y) vs. distance from nearest TSS (x) (legend)
pdf(file = "nearest_neighbor/piccolo_RNAseq_IFNG_4h_vs_UT/B2_STAT1_nearest_4h_vs_UT_nonresponsive_random750_freqHist.pdf", width = 7, height = 7)
...
ggplot(data = combined_nonresponsive) +
  geom_freqpoly(binwidth = 20, 
                ...
                aes(x = distance,
                    ...
                    y = ..count..),
                na.rm = TRUE) +
  labs(x = "Distance (kb) from nearest mouse piccolo BMDM nonresponsive", y = "Number of B2-derived STAT1 piccolo BMDM peaks") +
  scale_color_manual(values = c("royalblue3", "black", "#A9A9A9", "#E5E4E2","#7393B3")) +
  theme_bw() +
  xlim(0, 500) +
  ylim(0, 100) +
